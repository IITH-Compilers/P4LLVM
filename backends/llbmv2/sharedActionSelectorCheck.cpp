...
SharedActionSelectorCheck::preorder(const IR::P4Table* table) {
    ...
    if (type_extern_name != LLBMV2::TableImplementation::actionSelectorName) return false;
    ...
    for (auto ke : key->keyElements) {
        ...
        if (mt->name.name != LLBMV2::MatchImplementation::selectorMatchTypeName) continue;
